...
namespace RedRunner.Characters
{
    ...
    public class RedCharacter : Character
    {
        ...
        void Update()
        {
            ...
            Move(InputManager.Singleton.getHorizontalDirection());
            if (InputManager.Singleton.isJumpPressed() || CrossPlatformInputManager.GetButtonDown("Jump"))
            {
                Jump();
            }
            ...
            if (InputManager.Singleton.isRollPressed() || Input.GetButtonDown("Roll"))
            {
